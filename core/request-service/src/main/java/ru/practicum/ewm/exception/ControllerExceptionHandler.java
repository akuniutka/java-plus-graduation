...
class ControllerExceptionHandler extends BaseExceptionHandler {
    ...
    @ExceptionHandler
    public ResponseEntity<Object> handleDatabaseConstraintViolation(final DataIntegrityViolationException exception) {
        log.warn(exception.getMessage());
    ...
    @ExceptionHandler
    public ResponseEntity<Object> handleNotPossibleException(final NotPossibleException exception) {
        log.warn(exception.getMessage());
        final ApiError apiError = ApiError.builder()
                .status(HttpStatus.CONFLICT)
    ...
    @ExceptionHandler
    public ResponseEntity<Object> handleEventNotFoundException(final EventNotFoundException exception) {
        log.warn(exception.getMessage());
        final ApiError apiError = ApiError.builder()
                .status(HttpStatus.NOT_FOUND)
                .reason("The required object was not found")
